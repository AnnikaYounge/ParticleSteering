...
class PreferenceModel(Model):
    ...
    def pre_compute_mean_activations(self, dump_dir, **kwargs):
        # RePS / PreferenceVector: steering strength is factor * w (learned ||w||); max_act is not
        # used at infer (AdditionIntervention gets max_act=1). Latent max_act parquet is for
        # concept-detection evaluators only. SDL alternative (LsReFT): see Model.pre_compute_
        # mean_activations and use_max_act_steering_calibration on ParticleSteering.
